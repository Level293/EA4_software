...
export const INITIAL_REGISTRATIONS: VehicleRegistration[] = [
  {
    id: 'ADU-CL-2026-00001',
    createdAt: '2026-06-24T12:00:00Z',
    driverName: 'Juan Carlos Silva Castro',
    driverRut: '15.482.901-2',
    driverEmail: 'j.silva@gmail.com',
    driverPhone: '+56 9 7483 9102',
    driverAddress: 'Avenida O\'Higgins 450, Los Andes',
    isOwner: true,
    plate: 'AA-BB-11',
    ...
    model: 'RAV4',
    year: 2022,
    chassisNumber: '9B3H5200M04829384',
    motorNumber: 'ENG8392812',
    color: 'Blanco Plata',
    insuranceCompany: 'HDI Seguros (SOAPEX)',
    insurancePolicyNumber: 'SPX-482912',
    departureDate: '2026-06-25',
    returnDate: '2026-07-15',
    passengerCount: 2,
    destination: 'Mendoza Centro',
    status: 'aprobado',
  },
  {
